    ...
    <div class="col-md-12 grid-margin">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" action="{{ route('admin.article.update',$article->article_id) }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="published_at" class="form-control" id="published_at" placeholder="Tanggal Publikasi" value="{{ date('Y-m-d',strtotime($article->published_at)) }}">
                    </div>
                    <div class="form-group">
                        <label for="source_url">Link Sumber</label>
                        <input type="url" name="source_url" class="form-control" id="source_url" placeholder="Link Sumber" value="{{ $article->source_url }}">
                    </div>
                    <div class="form-group">
