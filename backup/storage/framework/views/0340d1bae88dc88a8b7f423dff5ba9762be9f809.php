                ...
                <div class="row w-100 mx-0">
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                            ...
                            <form class="pt-3" action="<?php echo e(route('member.login.store')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
<?php /**PATH /home/u1548576/public_html/gmc/gmc/resources/views/member/login.blade.php ENDPATH**/ ?>